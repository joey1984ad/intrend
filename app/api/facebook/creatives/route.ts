...
function generateMockCreativeData() {
  const mockCreatives = [
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/600x315/10B981/FFFFFF?text=Video+Thumbnail',
    ...
    },
    {
      ...
      assets: [
        {
          imageUrl: 'https://via.placeholder.com/600x315/F59E0B/FFFFFF?text=Carousel+Item+1',
          videoUrl: null,
          thumbnailUrl: 'https://via.placeholder.com/120x120/F59E0B/FFFFFF?text=Item+1',
        },
        {
          imageUrl: 'https://via.placeholder.com/600x315/F59E0B/FFFFFF?text=Carousel+Item+2',
          videoUrl: 'https://sample-videos.com/zip/10/mp4/SampleVideo_1280x720_1mb.mp4',
          thumbnailUrl: 'https://via.placeholder.com/120x120/F59E0B/FFFFFF?text=Video+Item',
        },
        {
          imageUrl: 'https://via.placeholder.com/600x315/F59E0B/FFFFFF?text=Carousel+Item+3',
          videoUrl: null,
          thumbnailUrl: 'https://via.placeholder.com/120x120/F59E0B/FFFFFF?text=Item+3',
        },
      ],
      clicks: 567,
      impressions: 18923,
